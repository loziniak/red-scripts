...
request: object [
	...
	execute: function [] [
		...
		;print ["request data before and after prepare-data:"] ; DEBUG
		;probe this-request/data ; DEBUG
		...
		;print ["creating command line for curl..."] ; DEBUG
		command: rejoin [
...
;			"--trace-ascii % " ; DEBUG
		...
		;print ["calling curl..."] ; DEBUG
		result: call/output/error command out err
		;probe result ; DEBUG
		;probe out ; DEBUG
		;probe err ; DEBUG
		;print ["parsing response..."] ; DEBUG
		either result == 0 [
